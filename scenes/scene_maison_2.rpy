label scene_maison_2:
    ...
    partenaire "Tu arrives pile à temps, tes parents sont censés arriver dans 10 minutes. Oui, non , t'inquiète pas, j’ai fait une recette végétarienne et pas végan, ça ne les empêchera pas de râler tu sais."
    partenaire "Donc bon, un peu plus, un peu moins…Je veux bien faire des compromis, mais faut pas abuser non plus. "
